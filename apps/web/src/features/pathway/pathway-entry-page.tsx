...
export function PathwayEntryPage() {
  ...
  function onOpenDirect(event: FormEvent<HTMLFormElement>) {
    ...
    if (id) navigate(`/care-plans/${encodeURIComponent(id)}`);
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Chronic vs episodic bifurcation explainer */}
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Card>
          ...
          <CardBody>
            <p className="text-sm text-gray-600">
              Pour une consultation ou un épisode aigu. Un épisode peut être basculé en parcours
              chronique si le suivi doit se prolonger.
            </p>
          </CardBody>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader
          ...
          description="Par identifiant HPHII ou par nom, puis ouvrez son parcours de soins."
        />
        <CardBody>
      ...
      {!hasPatientFilter(filters) ? (
        <EmptyState
          ...
          description="Saisissez un identifiant ou un nom, puis lancez la recherche pour ouvrir un parcours."
        />
      ) : query.isLoading ? (
      ...
      <Card>
        <CardHeader
          ...
          description="Si vous connaissez l’identifiant logique HAPI du patient, accédez directement à son parcours."
        />
        <CardBody>
